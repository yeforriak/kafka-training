...
public class ShakespeareValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ShakespeareValue\",\"namespace\":\"stubs.model\",\"fields\":[{\"name\":\"line_number\",\"type\":\"int\",\"doc\":\"The line number for line\"},{\"name\":\"line\",\"type\":\"string\",\"doc\":\"The line from Shakespeare\"}]}");
  ...
  public static stubs.model.ShakespeareValue.Builder newBuilder() {
    return new stubs.model.ShakespeareValue.Builder();
  }
  
  /** Creates a new ShakespeareValue RecordBuilder by copying an existing Builder */
  public static stubs.model.ShakespeareValue.Builder newBuilder(stubs.model.ShakespeareValue.Builder other) {
    return new stubs.model.ShakespeareValue.Builder(other);
  }
  
  /** Creates a new ShakespeareValue RecordBuilder by copying an existing ShakespeareValue instance */
  public static stubs.model.ShakespeareValue.Builder newBuilder(stubs.model.ShakespeareValue other) {
    return new stubs.model.ShakespeareValue.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShakespeareValue>
    ...
    private Builder() {
      super(stubs.model.ShakespeareValue.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(stubs.model.ShakespeareValue.Builder other) {
      super(other);
    ...
    private Builder(stubs.model.ShakespeareValue other) {
            super(stubs.model.ShakespeareValue.SCHEMA$);
      if (isValidValue(fields()[0], other.line_number)) {
        this.line_number = data().deepCopy(fields()[0].schema(), other.line_number);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'line_number' field */
    public stubs.model.ShakespeareValue.Builder setLineNumber(int value) {
    ...
    public stubs.model.ShakespeareValue.Builder clearLineNumber() {
    ...
    /** Sets the value of the 'line' field */
    public stubs.model.ShakespeareValue.Builder setLine(java.lang.CharSequence value) {
    ...
    public stubs.model.ShakespeareValue.Builder clearLine() {
      line = null;
