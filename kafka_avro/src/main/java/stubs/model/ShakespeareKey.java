...
public class ShakespeareKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ShakespeareKey\",\"namespace\":\"stubs.model\",\"fields\":[{\"name\":\"work\",\"type\":\"string\",\"doc\":\"The name of the work\"},{\"name\":\"year\",\"type\":\"int\",\"doc\":\"The year the work was published\"}]}");
  ...
  public static stubs.model.ShakespeareKey.Builder newBuilder() {
    return new stubs.model.ShakespeareKey.Builder();
  }
  
  /** Creates a new ShakespeareKey RecordBuilder by copying an existing Builder */
  public static stubs.model.ShakespeareKey.Builder newBuilder(stubs.model.ShakespeareKey.Builder other) {
    return new stubs.model.ShakespeareKey.Builder(other);
  }
  
  /** Creates a new ShakespeareKey RecordBuilder by copying an existing ShakespeareKey instance */
  public static stubs.model.ShakespeareKey.Builder newBuilder(stubs.model.ShakespeareKey other) {
    return new stubs.model.ShakespeareKey.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShakespeareKey>
    ...
    private Builder() {
      super(stubs.model.ShakespeareKey.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(stubs.model.ShakespeareKey.Builder other) {
      super(other);
    ...
    private Builder(stubs.model.ShakespeareKey other) {
            super(stubs.model.ShakespeareKey.SCHEMA$);
      if (isValidValue(fields()[0], other.work)) {
        this.work = data().deepCopy(fields()[0].schema(), other.work);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'work' field */
    public stubs.model.ShakespeareKey.Builder setWork(java.lang.CharSequence value) {
    ...
    public stubs.model.ShakespeareKey.Builder clearWork() {
      work = null;
    ...
    /** Sets the value of the 'year' field */
    public stubs.model.ShakespeareKey.Builder setYear(int value) {
    ...
    public stubs.model.ShakespeareKey.Builder clearYear() {
